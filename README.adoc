...
2. To set up your environment, please see the requirements listed in https://github.com/eBay/ebay-oauth-python-client/requirements.txt[requirements.txt]  You can run $ pip install -r requirements.txt command to install all the requirements.
